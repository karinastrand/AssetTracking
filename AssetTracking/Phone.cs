...
public class Phone : Asset
{
    ...
    public override Asset AssetFromString(string stringAsset)
    {
        ...
        Phone savedAsset = new Phone(assetParts[0], assetParts[1],assetParts[2], Convert.ToDouble(assetParts[3]), Convert.ToDateTime(assetParts[4]), Convert.ToInt32(assetParts[5]));
        return savedAsset;
    }
